...

{
  ...
  hooks = ''
    ...
    echo "$GIT_CONFIG_FILE_CONTENTS" >> "$GIT_CONFIG_FILE"
    ...
    echo "$MYSTUFF_GIT_CONFIG_FILE_CONTENTS" >> "$MYSTUFF_GIT_CONFIG_FILE"
    ...
    echo "$PERSONAL_WORK_GIT_CONFIG_FILE_CONTENTS" >> "$PERSONAL_WORK_GIT_CONFIG_FILE"
    ...
    *.rs    diff=rust'
    ...
    echo "$GIT_ATTRIBUTES_FILE_CONTENTS" >> "$GIT_ATTRIBUTES_FILE"
    ...
    echo "$MERCURIAL_CONFIG_FILE_CONTENTS" >> "$MERCURIAL_CONFIG_FILE"
